...
This is a forked repo from git://github.com/robbyrussell/oh-my-zsh.git

I created a new theme 'dstufft_custom' based on the original 'dstufft' theme and a new .zshrc template.
...
1. Clone the repository
  ...
  @git clone git://github.com/gonzalomcruz/oh-my-zsh.git ~/.oh-my-zsh@
